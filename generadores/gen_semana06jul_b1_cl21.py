...
os.makedirs(CV, exist_ok=True); os.makedirs(GV, exist_ok=True)

# ---------------- CONV ----------------
md_to_pdf(os.path.join(CV, 'B1_Clase21_CONV_PRINT.md'),
          os.path.join(CV, 'B1_Clase21_CONV_GUIA.pdf'))
...
build_report_v2(
    os.path.join(CV, 'B1_Clase21_CONV_REPORTE.pdf'),
...
md_to_pdf(os.path.join(GV, 'B1_Clase21_GRAMMAR_PRINT.md'),
          os.path.join(GV, 'B1_Clase21_GRAMMAR_GUIA.pdf'))
...
build_report_v2(
    os.path.join(GV, 'B1_Clase21_GRAMMAR_REPORTE.pdf'),
