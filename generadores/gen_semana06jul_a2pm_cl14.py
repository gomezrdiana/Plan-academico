...
JUSTICIA v1 dia 4. Cierre estandar; rituales (portafolio + ticket) corren desde Cl 1."""
import os
...
acts = [
    ...
    ('BLOQUE 4 - Cierre: ticket de salida (present perfect irregular, recogido sin evaluar) + tarea + error paper + VATS + anuncio Cl 15', '18 min'),
]
deliv = [
    'Reporte firmado',
...
build_report_v2(os.path.join(A2_2H, 'REPORTES', 'A2_Class14_REPORTE.pdf'),
    ...
    'M16 I Have Gone to Paris (participios irregulares been/taken/driven/woken up/eaten/gone/told/found, p.147-162) + simulacion Travel Agency + ticket de salida (rituales corren desde Cl 1)',
    acts, deliv, ev, S)
