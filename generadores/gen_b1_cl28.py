...
md_to_pdf(os.path.join(B1, 'CONVERSACION', 'B1_Clase28_CONV_PRINT.md'),
          os.path.join(B1, 'CONVERSACION', 'GUIAS', 'B1_Clase28_CONV_GUIA.pdf'))
print('OK: B1_Clase28_CONV_GUIA.pdf')

md_to_pdf(os.path.join(B1, 'GRAMATICA', 'B1_Clase28_GRAMMAR_PRINT.md'),
          os.path.join(B1, 'GRAMATICA', 'GUIAS', 'B1_Clase28_GRAMMAR_GUIA.pdf'))
