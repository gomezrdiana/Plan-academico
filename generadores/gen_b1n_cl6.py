...
"""B1 MASTERY 4h Cl 6 — HOJA DE RUTA (2 tracks). Solo GUIAS (no reportes).
CONV + GRAMMAR: Present Simple (A1 Book M8 p.99-102 / M9 p.111-113 / have-has M17 p.210).
TEMPLANZA v1 dia 1 (ABRE). Genera 2 PDFs en VERSION_2/B1_4H/GUIAS/."""
import os
